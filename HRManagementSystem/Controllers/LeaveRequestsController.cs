...
namespace HRManagementSystem.Controllers
{
    public class LeaveRequestsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeId,LeaveType,StartDate,EndDate,Reason,Status")] LeaveRequest leaveRequest)
        {
